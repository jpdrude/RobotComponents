...
namespace RobotComponents.ABB.Gh.Goos.Definitions
{
    ...
    public class GH_RobotTool : GH_GeometricGoo<RobotTool>, IGH_PreviewData, GH_ISerializable
    {
        ...
        public override bool CastFrom(object source)
        {
            ...
            {
                if (source is RobotTool robotTool)
                {
                    Value = robotTool;
                    return true;
                }
            ...
            if (typeof(GH_Declaration).IsAssignableFrom(source.GetType()))
            {
                ...
                if (declarationGoo.Value is RobotTool robotTool)
                {
                    Value = robotTool;
                    return true;
                }
        ...
        public override bool Read(GH_IReader reader)
        {
            ...
            this.Value = (RobotTool)RobotComponents.Utils.Serialization.ByteArrayToObject(array);
