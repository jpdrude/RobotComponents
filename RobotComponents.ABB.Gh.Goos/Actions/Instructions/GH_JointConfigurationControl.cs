...
namespace RobotComponents.ABB.Gh.Goos.Actions.Instructions
{
    ...
    public class GH_JointConfigurationControl : GH_Goo<JointConfigurationControl>, GH_ISerializable
    {
        ...
        public override bool CastTo<Q>(ref Q target)
        {
            ...
            {
                if (Value == null) { target = (Q)(object)new GH_JointConfigurationControl(); }
        ...
        public override bool Read(GH_IReader reader)
        {
            ...
            this.Value = (JointConfigurationControl)RobotComponents.Utils.Serialization.ByteArrayToObject(array);
