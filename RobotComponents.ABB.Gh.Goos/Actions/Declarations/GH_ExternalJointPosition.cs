...
namespace RobotComponents.ABB.Gh.Goos.Actions.Declarations
{
    ...
    public class GH_ExternalJointPosition : GH_Goo<ExternalJointPosition>, GH_ISerializable
    {
        ...
        public override bool CastFrom(object source)
        {
            ...
            {
                if (source is ExternalJointPosition jointPosition)
                {
                    Value = jointPosition;
                    return true;
                }
            ...
            if (typeof(GH_Declaration).IsAssignableFrom(source.GetType()))
            {
                ...
                if (declarationGoo.Value is ExternalJointPosition jointPosition)
                {
                    Value = jointPosition;
                    return true;
                }
        ...
        public override bool Read(GH_IReader reader)
        {
            ...
            this.Value = (ExternalJointPosition)RobotComponents.Utils.Serialization.ByteArrayToObject(array);
