...
{
    /// <summary>
    /// Represent the robot data of the IRB1300-10/1.15.
    /// </summary>
    public class IRB1300_10_115 : RobotPresetData
    {
        #region properties
        /// <summary>
        ...
        {
            get { return "IRB1300-10/1.15"; }
        }

        /// <summary>
        /// Gets the kinematics parameters.
        /// </summary>
        public override RobotKinematicParameters RobotKinematicParameters => new RobotKinematicParameters(150, -40, -0, 0, 544, 575, 425, 90);
        ...
        {
            "IRB1300_10_115_link_0",
            "IRB1300_10_115_link_1",
            "IRB1300_10_115_link_2",
            "IRB1300_10_115_link_3",
            "IRB1300_10_115_link_4",
            "IRB1300_10_115_link_5",
            "IRB1300_10_115_link_6"
        };
        #endregion
    }
}
