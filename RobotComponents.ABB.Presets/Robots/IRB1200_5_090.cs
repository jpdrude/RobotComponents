...
{
    /// <summary>
    /// Represent the robot data of the IRB1200-5/0.9.
    /// </summary>
    public class IRB1200_5_090 : RobotPresetData
    {
        #region properties
        /// <summary>
        ...
        {
            get { return "IRB1200-5/0.9"; }
        }

        /// <summary>
        /// Gets the kinematics parameters.
        /// </summary>
        public override RobotKinematicParameters RobotKinematicParameters => new RobotKinematicParameters(0, -42, -0, 0, 399.1, 448, 451, 82);
        ...
        {
            "IRB1200_5_090_link_0",
            "IRB1200_5_090_link_1",
            "IRB1200_5_090_link_2",
            "IRB1200_5_090_link_3",
            "IRB1200_5_090_link_4",
            "IRB1200_5_090_link_5",
            "IRB1200_5_090_link_6"
        };
        #endregion
    }
}
