...
{
    /// <summary>
    /// Represent the robot data of the IRB1300-7/1.4.
    /// </summary>
    public class IRB1300_7_140 : RobotPresetData
    {
        #region properties
        /// <summary>
        ...
        {
            get { return "IRB1300-7/1.4"; }
        }

        /// <summary>
        /// Gets the kinematics parameters.
        /// </summary>
        public override RobotKinematicParameters RobotKinematicParameters => new RobotKinematicParameters(150, -40, -0, 0, 544, 575, 675, 90);
        ...
        {
            "IRB1300_7_140_link_0",
            "IRB1300_7_140_link_1",
            "IRB1300_7_140_link_2",
            "IRB1300_7_140_link_3",
            "IRB1300_7_140_link_4",
            "IRB1300_7_140_link_5",
            "IRB1300_7_140_link_6"
        };
        #endregion
    }
}
