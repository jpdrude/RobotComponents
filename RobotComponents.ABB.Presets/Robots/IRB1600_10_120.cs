...
{
    /// <summary>
    /// Represent the robot data of the IRB1600-10/1.2.
    /// </summary>
    public class IRB1600_10_120 : RobotPresetData
    {
        #region properties
        /// <summary>
        ...
        {
            get { return "IRB1600-10/1.2"; }
        }

        /// <summary>
        /// Gets the kinematics parameters.
        /// </summary>
        public override RobotKinematicParameters RobotKinematicParameters => new RobotKinematicParameters(150, -0, -0, 0, 486.5, 475, 600, 65);
        ...
        {
            "IRB1600_10_120_link_0",
            "IRB1600_10_120_link_1",
            "IRB1600_10_120_link_2",
            "IRB1600_10_120_link_3",
            "IRB1600_10_120_link_4",
            "IRB1600_10_120_link_5",
            "IRB1600_10_120_link_6"
        };
        #endregion
    }
}
