...
{
    /// <summary>
    /// Represent the robot data of the IRB1100-4/0.475.
    /// </summary>
    public class IRB1100_4_0475 : RobotPresetData
    {
        #region properties
        /// <summary>
        ...
        {
            get { return "IRB1100-4/0.475"; }
        }

        /// <summary>
        /// Gets the kinematics parameters.
        /// </summary>
        public override RobotKinematicParameters RobotKinematicParameters => new RobotKinematicParameters(0, -10, -0, 0, 327, 225, 250, 64);
        ...
        {
            "IRB1100_4_0475_link_0",
            "IRB1100_4_0475_link_1",
            "IRB1100_4_0475_link_2",
            "IRB1100_4_0475_link_3",
            "IRB1100_4_0475_link_4",
            "IRB1100_4_0475_link_5",
            "IRB1100_4_0475_link_6"
        };
        #endregion
    }
}
