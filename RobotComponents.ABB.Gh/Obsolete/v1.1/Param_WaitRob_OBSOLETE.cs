...
namespace RobotComponents.ABB.Gh.Parameters.Actions.Instructions
{
    ...
    /// </remarks>
    public class Param_WaitRob : GH_RobotParam<GH_WaitRob>
    {
        ...
        {
            get { return Properties.Resources.WaitRob_Parameter_Icon; }
        }
        ...
        {
            get { return new Guid("9B632A51-5011-468D-B978-31F7890B1F52"); }
        }
    }
}
