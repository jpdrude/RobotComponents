...
{
    /// <summary>
    /// RobotComponents Action : Joint Configuration Control component.
    /// </summary>
    public class JointConfigurationControlComponent : GH_RobotComponent
    {
        /// <summary>
        ...
        /// </summary>
        public JointConfigurationControlComponent() : base("Joint Configuration Control", "JCC", "Code Generation",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Create the action
            JointConfigurationControl jointConfigurationControl = new JointConfigurationControl(isActive);
