    ...
    public class WaitGIComponent : GH_RobotComponent
    {
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddParameter(new Param_RAPIDExpression(), "State", "S",
                "Desired state of the group input signal. Accepts an integer, RAPID variable, or RAPID expression.",
                GH_ParamAccess.item);
        }
        ...
        {
            pManager.RegisterParam(new Param_Action(), "Wait for Group Input", "WGI", "Resulting Wait for Group Input instruction");
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.SetData(0, new WaitGI(name, value));
        }
