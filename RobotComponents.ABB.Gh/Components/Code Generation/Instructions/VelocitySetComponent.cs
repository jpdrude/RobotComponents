...
{
    /// <summary>
    /// RobotComponents Action : Velocity Set component.
    /// </summary>
    public class VelocitySetComponent : GH_RobotComponent
    {
        /// <summary>
        ...
        /// </summary>
        public VelocitySetComponent() : base("Velocity Set", "VS", "Code Generation",
              "Defines an instruction to override and limit the TCP speed.")
        {
        }
        ...
        {
            get { return new Guid("4B68C42C-968C-472E-B3F6-A1A74537382F"); }
        }
        #endregion
    }
}
