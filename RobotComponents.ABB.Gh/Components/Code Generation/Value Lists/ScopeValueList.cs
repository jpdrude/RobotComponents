...
{
    /// <summary>
    /// RobotComponents Scope Value List. An inherent from the GH_Component Class.
    /// Creates a value list with the predefined scops. Since the value list is a special
    ...
    /// </summary>
    public class ScopeValueList : GH_RobotComponent
    {
        #region fields
        ...
        /// </summary>
        public ScopeValueList() : base("Predefined Scopes", "SC", "Code Generation", 
              "Defines a value list with available scopes.")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (_created == false)
            {
                ...
                _created = HelperMethods.CreateValueList(typeof(Scope), location);
            }
        ...
        {
            get { return Properties.Resources.ScopeValueList_Icon; }
        }
        ...
        {
            get { return new Guid("5D8A3C1E-92F7-4E83-B6D4-7F2E8A1C5B09"); }
        }
        #endregion
    }
}
