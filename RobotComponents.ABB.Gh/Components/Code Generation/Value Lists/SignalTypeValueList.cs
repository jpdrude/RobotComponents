...
{
    /// <summary>
    /// RobotComponents Sigal Type Value List. An inherent from the GH_Component Class.
    /// Creates a value list with the predefined signal types. Since the value list is a special
    ...
    /// </summary>
    public class SignalTypeValueList : GH_RobotComponent
    {
        #region fields
        ...
        /// </summary>
        public SignalTypeValueList() : base("Signal Types", "ST", "Code Generation", 
              "Defines a value list with available signal types.")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (_created == false)
            {
                ...
                _created = HelperMethods.CreateValueList(typeof(SignalType), location);
            }
        ...
        {
            get { return Properties.Resources.SignalTypeValueList_Icon; }
        }
        ...
        {
            get { return new Guid("D4E2F8A9-3C71-4B5E-92A6-8F1D6E0C7B3A"); }
        }
        #endregion
    }
}
