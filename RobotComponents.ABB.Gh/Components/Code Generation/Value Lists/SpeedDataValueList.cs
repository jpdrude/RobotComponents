...
{
    /// <summary>
    /// RobotComponents Speed Data Value List. An inherent from the GH_Component Class.
    /// Creates a value list with the predefined speeddata. Since the value list is a special
    ...
    /// </summary>
    public class SpeedDataValueList : GH_RobotComponent
    {
        #region fields
        ...
        /// </summary>
        public SpeedDataValueList() : base("Predefined Speed Data", "PSD", "Code Generation",
        ...
        {
            get { return Properties.Resources.SpeedDataValueList_Icon; }
        }
        ...
        {
            get { return new Guid("D8E510F8-0C36-4C3C-B9AE-0BDBFD75CE88"); }
        }
        #endregion
    }
}
