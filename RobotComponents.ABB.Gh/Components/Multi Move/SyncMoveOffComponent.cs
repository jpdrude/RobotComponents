...
namespace RobotComponents.ABB.Gh.Components.MultiMove
{
    ...
    public class SyncMoveOffComponent : GH_RobotComponent, IObjectManager
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Create the action
            SyncMoveOff syncMoveOff = new SyncMoveOff(name);

            // Output
            DA.SetData(0, syncMoveOff);
        }
        ...
        protected override void AfterSolveInstance()
        {
            ...
            _tree = this.Params.Output[0].VolatileData as GH_Structure<GH_SyncMoveOff>;
        ...
        {
            get { return Properties.Resources.SyncMoveOff_Icon; }
        }
