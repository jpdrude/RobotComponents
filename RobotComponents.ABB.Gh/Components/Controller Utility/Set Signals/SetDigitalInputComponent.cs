...
{
    /// <summary>
    /// Represents the component that gets and sets digital inputs on a defined controller.
    /// </summary>
    public class SetDigitalInputComponent : GH_RobotComponent
    {
        #region fields
        ...
        /// </summary>
        public SetDigitalInputComponent() : base("Set Digital Input", "SetDI", "Controller Utility",
