...
{
    /// <summary>
    /// Represents the component that gets and sets group outputs on a defined controller.
    /// </summary>
    public class SetGroupOutputComponent : GH_RobotComponent, IGH_VariableParameterComponent
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SetGroupOutputComponent class.
        /// </summary>
        public SetGroupOutputComponent() : base("Set Group Output", "SetGO", "Controller Utility",
              "Changes the state of a defined group output from an ABB controller in realtime."
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("Value", "V", "State of the Group Output as a number", GH_ParamAccess.item, 0);
        ...
        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            ...
            pManager.AddIntegerParameter("Value", "V", "Group Output Signal Value", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                signal = _controller.GetGroupOutput(name, out int index);
        ...
        {
            get { return Properties.Resources.SetGroupOutput_Icon; }
        }
        ...
        {
            get { return new Guid("D7E3B1F9-4A6C-42D5-9E8B-5C2F1A7D3E6B"); }
        }
        #endregion
