...
{
    /// <summary>
    /// Represents the component that gets digital outputs from a defined controller.
    /// </summary>
    public class GetDigitalOutputComponent : GH_RobotComponent
    {
        #region fields
        ...
        /// </summary>
        public GetDigitalOutputComponent() : base("Get Digital Output", "GetDO", "Controller Utility",
