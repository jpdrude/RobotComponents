...
{
    /// <summary>
    /// Represents the component that gets snalog outputs from a defined controller.
    /// </summary>
    public class GetAnalogOutputComponent : GH_RobotComponent
    {
        #region fields
        ...
        /// </summary>
        public GetAnalogOutputComponent() : base("Get Analog Output", "GetAO", "Controller Utility",
