...
{
    /// <summary>
    /// Represents the component that gets group inputs from a defined controller.
    /// </summary>
    public class GetGroupInputComponent : GH_RobotComponent
    {
        #region fields
        ...
        /// <summary>
        /// Initializes a new instance of the GetGroupInputComponent class.
        /// </summary>
        public GetGroupInputComponent() : base("Get Group Input", "GetGI", "Controller Utility",
              "Gets the signal of a defined group input from an ABB controller."
        ...
        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Name", "N", "Group Input Name as text", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                Signal signal = _controller.GetGroupInput(name, out int index);
        ...
        {
            get { return Properties.Resources.GetGroupInput_Icon; }
        }
        ...
        {
            get { return new Guid("8D2E4F7A-C3B1-49E6-A5D8-2F6C9E1B3A7D"); }
        }
        #endregion
