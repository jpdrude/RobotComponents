...
{
    /// <summary>
    /// Represents the component that gets the external joint positions from a defined controller.
    /// </summary>
    public class GetExternalJointPositionsComponent : GH_RobotComponent
    {
        #region fields
