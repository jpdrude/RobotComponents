...
using RobotComponents.ABB.Gh.Goos.Actions.Dynamic;

namespace RobotComponents.ABB.Gh.Parameters.Actions.Dynamic
{
    /// <summary>
    /// Comment parameter
    /// </summary>
    public class Param_Comment : GH_RobotParam<GH_Comment>
    {
        ...
        /// </summary>
        public Param_Comment() : base("Comment", "C", "Parameters",
